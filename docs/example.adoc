...
<6> Host can be _localhost_ because there is a bindPort forwarding between container and _Docker_ server.
...
Ports 8080 (Tomcat standard bindPort) and 8089(JMX bindPort used by Arquillian) are exposed.
